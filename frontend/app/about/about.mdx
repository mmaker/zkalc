...
<center>
_[zkalc](https://github.com/mmaker/zkalc) helps you calculate how much time
...
- Find the existing benchmarks in the `backend/` directory, and add benchmark
  ...
  [already existing conventions](https://github.com/mmaker/zkalc/blob/main/backend/blstrs/benches/bench_blstrs.rs).
...
[understands a small subset](https://github.com/mmaker/zkalc/blob/main/perf/fit.py#L128)
of the
[format](https://github.com/mmaker/zkalc/blob/main/perf/blstrs/estimates.json)
