...
zkalc's purpose is to answer questions like *"How quickly can I run an MSM of size <InlineMath math="2^{18}" /> and compute <InlineMath math="2^6" /> pairings in an AWS C5 machine?"*.
