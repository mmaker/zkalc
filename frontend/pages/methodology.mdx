...
<br />
<center>
<Image src={benchmark_data} width={1280} alt="" />
</center>
<br />
...
<br />
<center>
<Image src={interpolation} width={1280} alt="" />
</center>
<br />
...
Observe that the rightmost polynomial is linear and hence it's not able to faithfully follow the non-linear <InlineMath math="f(x)" />. Hence zkalc will get more and more inaccurate the bigger <InlineMath math="n" /> is. See our [TODO document](https://github.com/zkalc/zkalc/blob/main/TODO.md) for possible improvements here.
